...
namespace Kumara.WebApi.Migrations
{
    ...
    [Migration("20250817222722_AddMissingNodatimeMigrations")]
    partial class AddMissingNodatimeMigrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kumara.WebApi.Models.Activity", b =>
                {
                    ...
                    b.Property<OffsetDateTime?>("PlannedFinish")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("planned_finish");

                    b.Property<OffsetDateTime?>("PlannedStart")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("Kumara.WebApi.Models.Setting<Kumara.WebApi.Types.Settings, Kumara.WebApi.Types.SettingKey>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.OwnsMany("Kumara.WebApi.Models.RecentProgressEntry", "RecentProgressEntries", b1 =>
                        {
                            ...
                            b1.Property<LocalDate>("ProgressDate")
                                .HasColumnType("date")
